...
function checkSavedDiagram() {
  if (localStorage.getItem('diagram')) {
    ...
    const diagram = {
      ...
      relations: [
        { id: 0, name: 'Relation1', formula: "variables[1] + variables[2]", value: 0},
        { id: 1, name: 'Relation2', formula: "variables[1] * relations[0]", value: 0},
        { id: 2, name: 'Relation3', formula: "relations[1] - variables[5]", value: 0},
      ],
      variables: [
        { id: 0, name: 'Variable1', value: 1},
        { id: 1, name: 'Variable2', value: 2},
        { id: 2, name: 'Variable3', value: 3},
        { id: 3, name: 'Variable4', value: 4},
        { id: 4, name: 'Variable5', value: 5},
        { id: 5, name: 'Variable6', value: 6},
      ],
      selected: null,
    };
      ...
      return {
        ...
        containers: state.containers.map(container =>
          container.id === action.payload.containerId
            ? { ...container, relations: [...container.relations, action.payload.id] }
            : container
        ),
      };
